...
public class Order implements Parcelable {
    ...
    public void setmProductType(ProductType mProductType) {
    ...
    protected Order(Parcel in) {
        ...
        mProductType = (ProductType) in.readValue(ProductType.class.getClassLoader());
